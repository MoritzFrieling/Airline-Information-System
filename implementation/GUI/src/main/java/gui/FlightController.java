...
class FlightController implements Initializable {
    ...
    private FlightData createFlight() {
        if (modelDropDownRoute.getSelectionModel().isSelected(0) && modelDropDownPlane.getSelectionModel().isSelected(0) && !departureTime.getText().isEmpty()) {
            ...
            AirportData origin = new AirportData( "Berlin Flughafen", "BRLN", "Germany", new CoordinateData(40.446,-79.982), "Berlin", "UTC");
            AirportData destination = new AirportData( "New York Airport", "NY", "USA", new CoordinateData(30.456,-20.345), "New York", "PRT");
